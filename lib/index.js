...
server.route({ method: 'GET', path: '/dashboard', config: { handler: Dashboard.getDashboard }});
...
var css = { handler: { directory: { listing: false, index: false, path: './content/css' } } };
var js = { handler: { directory: { listing: false, index: false, path: './content/js' } } };
